...
namespace LoanManagement.Repository.LoanRepository
{
    internal class LoanRepository : ILoanRepository
    {
        ...
        {
            sqlCommand.CommandText = "insert into Loan (CustomerID,PrincipalAmount,InterestRate,LoanTerm,LoanType,LoanStatus) OUTPUT INSERTED.LoanID values (@cusId,@amt,@rate,@term,@type,@status)";
            ...
            int newLoanId = (int)sqlCommand.ExecuteScalar();

            if (loan is HomeLoan homeLoan)
            {
                sqlCommand.CommandText = "INSERT INTO HomeLoan (LoanID, PropertyAddress, PropertyValue) VALUES (@LoanID, @PropertyAddress, @PropertyValue)";
                sqlCommand.Parameters.Clear();
                sqlCommand.Parameters.AddWithValue("@LoanID", newLoanId);
                sqlCommand.Parameters.AddWithValue("@PropertyAddress", homeLoan.PropertyAddress);
                sqlCommand.Parameters.AddWithValue("@PropertyValue", homeLoan.PropertyValue);
            }
            else if (loan is CarLoan carLoan)
            {
                sqlCommand.CommandText = "INSERT INTO CarLoan (LoanID, CarModel, CarValue) VALUES (@LoanID, @CarModel, @CarValue)";
                sqlCommand.Parameters.Clear();
                sqlCommand.Parameters.AddWithValue("@LoanID", newLoanId);
                sqlCommand.Parameters.AddWithValue("@CarModel", carLoan.CarModel);
                sqlCommand.Parameters.AddWithValue("@CarValue", carLoan.CarValue);
            }
